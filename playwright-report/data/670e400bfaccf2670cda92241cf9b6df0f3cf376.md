...
- Name: jobs.spec.ts >> Job Discovery Flow >> should display filters section
- Location: e2e\jobs.spec.ts:19:7
...
Locator: locator('input[placeholder*="Skills"]')
Expected: visible
Timeout: 5000ms
...
- main:
  ...
  - text: Remote Only Showing 4 jobs
