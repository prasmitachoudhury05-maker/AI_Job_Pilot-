...
- Name: jobs.spec.ts >> Job Detail View >> should navigate to job detail page
- Location: e2e\jobs.spec.ts:92:7
...
Expected pattern: /\/jobs\/\d+/
Received string:  "http://localhost:3000/jobs"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "http://localhost:3000/jobs"
...
- main:
  ...
  - img
  - textbox "Search jobs (e.g., Software Engineer, Data Scientist)"
  - img
  - textbox "Location (e.g., San Francisco, Remote)"
  - button "Discover Jobs" [disabled]:
    - img
    - text: Discover Jobs
  - img
