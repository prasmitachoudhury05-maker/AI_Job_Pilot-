...
- Name: ranking.spec.ts >> Ranking Flow E2E Tests >> should navigate back to dashboard from detail view
- Location: e2e\ranking.spec.ts:121:7
...
Call log:
  ...
  - waiting for locator('h1')
    5 × locator resolved to <h1 class="text-2xl font-bold text-white tracking-tight flex items-center gap-2">…</h1>
