...
- Name: profile.spec.ts >> Profile Dashboard >> should display education section
- Location: e2e\profile.spec.ts:178:7
...
Error: strict mode violation: locator('text=Education') resolved to 2 elements:
    1) <h2 class="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">…</h2> aka getByRole('heading', { name: 'Education' })
    2) <p class="text-gray-500">No education added yet</p> aka getByText('No education added yet')
