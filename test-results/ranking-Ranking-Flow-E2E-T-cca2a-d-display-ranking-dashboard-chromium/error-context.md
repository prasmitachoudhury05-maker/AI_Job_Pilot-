...
- Name: ranking.spec.ts >> Ranking Flow E2E Tests >> should display ranking dashboard
- Location: e2e\ranking.spec.ts:9:7
...
Locator: locator('h1')
Expected substring: "Job Ranking Dashboard"
...
Call log:
  ...
  - waiting for locator('h1')
    7 × locator resolved to <h1 class="text-2xl font-bold text-white tracking-tight flex items-center gap-2">…</h1>
      - unexpected value "JJobPilot"
        ...
        - generic [ref=e54]:
          ...
          - generic [ref=e59]:
            ...
            - button "Export" [ref=e66] [cursor=pointer]:
              - img [ref=e67]
              - text: Export
        - paragraph [ref=e71]: "API Cost: $0.0003 | Tokens Used: 300"
      - generic [ref=e72]:
        - generic [ref=e73]:
